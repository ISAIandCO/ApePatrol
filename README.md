...
- SEC AI chat: один session-диалог на вкладку SIEM с несколькими явно прикладываемыми событиями, безопасным Markdown-рендерингом, переносом в Workspace и постоянным диалогом расследования;
