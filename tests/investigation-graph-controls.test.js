...
describe("investigation graph controls", () => {
  it("uses the shared dynamic force engine with a collapsed settings panel", async () => {
    ...
    const script = await readFile(new URL(import.meta.resolve("@isaiandco/ape-share-core/ui/investigation-canvas")), "utf8");
    ...
    expect(script).toContain('from "../graph/force-layout.js"');
